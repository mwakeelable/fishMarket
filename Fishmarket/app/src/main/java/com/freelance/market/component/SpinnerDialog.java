package com.freelance.market.component;
...
public class SpinnerDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getWindow().setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.spinner_progress_dialog_bg));
